...
class _AppDashboardState extends State<AppDashboard> {
            ...
            onSelected: (value) {
              switch (value) {
                case 1:
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const NewOder()),
                  );
                  break;
                case 2:
                  Navigator.push(
  ...
  Widget cardBox(String title, IconData icon, {VoidCallback? onTap}) {
    return SizedBox(
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Icon(icon, size: 55, color: AppColors.white),
                ),
                SizedBox(height: 10),
                Text(
                  title.toUpperCase(),
